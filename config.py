...
API_KEY = "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"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey1,fkxxxx-api2dkey2"
...
LLM_MODEL = "chatglm-6b-int4-qe" # 可选 ↓↓↓
AVAIL_LLM_MODELS = ["gpt-3.5-turbo", "api2d-gpt-3.5-turbo", "gpt-4", "api2d-gpt-4", "chatglm-6b-int4", "chatglm-6b-int4-qe", "moss", "newbing"]
